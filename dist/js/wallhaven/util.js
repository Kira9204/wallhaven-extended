...
const setWallhavenSortByUrlParam = (url) => {
...
const setWallhavenPageUrlParam = (url) => {
...
const setWallhavenTopRangeUrlParam = (url) => {
    if (wallhavenSettings.sorting.sortByAge !== WALLHAVEN_SORT_BY_AGE.None &&
...
const setWallhavenCategoryUrlParam = (url) => {
    let categoriesParam = '';
...
const setWallhavenPurityUrlParam = (url) => {
    let purityParam = '';
...
const setWallhavenMinDimensionsUrlParam = (url) => {
...
const setWallhavenRatioUrlParam = (url) => {
